    ...
    <section className="py-14 bg-stone-50" aria-label="Tin tức">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <Link
            href="/tin-tuc"
            className="hidden sm:inline-flex items-center gap-1.5 text-sm text-amber-600 font-medium border border-amber-300 hover:bg-amber-50 px-4 py-2 rounded-lg transition-colors"
          >
            Xem thêm
        ...
        <div className="mt-8 text-center sm:hidden">
          <Link
            href="/tin-tuc"
            className="inline-flex items-center gap-1.5 text-sm text-amber-600 font-medium border border-amber-300 hover:bg-amber-50 px-5 py-2.5 rounded-lg transition-colors"
          >
            Xem thêm tin tức
          </Link>
        </div>
