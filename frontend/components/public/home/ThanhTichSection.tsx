function PotteryIcon() {
  return (
    <svg className="w-7 h-7 text-amber-100" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex items-center justify-center gap-3" aria-hidden="true">
            ...
            <svg className="w-4 h-4 text-amber-500" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {ACHIEVEMENTS.map(({ icon: Icon, title, description }) => (
            ...
            >
              {/* Icon */}
              <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-red-900 to-red-800 flex items-center justify-center mb-5 shadow-sm group-hover:from-amber-600 group-hover:to-amber-700 transition-all duration-300">
                <Icon />
              </div>
              {/* Title */}
